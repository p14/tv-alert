...
export const buildMagicLinkEmail = ({
    ...
    return (
        `
            <p>Hey there,</p>
            <p>To access your account on TV Alert, please verify your email address by clicking the link below. This link will expire in 24 hours and will grant you access to your account throughout that time. Feel free to request another link at anytime.</p>
